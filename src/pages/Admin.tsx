...
import {
  ...
  MessageSquare, Smartphone, Bell, Plus, Upload, Trash2, Save, RefreshCw, Home, Layout, Phone, Video, Trophy, Bot, BookOpen
} from 'lucide-react';
...
type Tab = 'home' | 'content' | 'courses' | 'users' | 'signals' | 'analytics' | 'vip' | 'payments' | 'notifications' | 'apk' | 'themes' | 'sounds' | 'header' | 'settings' | 'referrals' | 'testimonials' | 'ai' | 'avax_ai' | 'calls' | 'meetings' | 'challenge' | 'journal' | 'profile_styles';
